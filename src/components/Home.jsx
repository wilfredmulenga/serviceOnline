          ...
          <div>
            ...
            <div
              ...
              <p
                ...
                Helping you get the right service
              </p>
            </div>
          </div>
                ...
                <div className="col-4">
                  ...
                  <div className="card mt-3">
                    ...
                    <p className="card-text">
                      Our platform creates lets people who are not in the formal sector be able to
                      list their skills and services thus opening up the window that has been
                      overlooked by other Job-listing sites. Whether you are a Carpenter, Welder,
                      Barberman, this site will help bring the customers to you.
                    </p>
                  </div>
                </div>
                <div className=" col-4 ">
                  ...
                  <div className="card mt-3">
                    ...
                    <p className="card-text">
                      Looking for a good hairdresser but just don't know where to look. Or maybe
                      your Kitchen needs some remodeling. Our platform lists the very best
                      professionals in the informal job sector, skilled for the job you may require.
                      Feel free to browse through our category section to get started.
                    </p>
                  </div>
                </div>
